...
<body>
    ...
    <a href="/gallery/register" role="button" class="btn btn-primary">사진 등록</a>
			...
			<c:forEach var="file" items="${list}" varStatus="status">
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="project">
						...
						<img src="${display}${file.fileUrl}" class="img-fluid" alt="Colorlib Template" style="height:400px;width:100%;"/>
						<div class="text">
